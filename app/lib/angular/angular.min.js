...
(function(D, U, s) {
	...
	function r(b, a, c) {
		...
		if (b)
			...
			else if (xb(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
			...
			(a = b) &&
				(I(b)
					...
					: na(b)
						...
						: bb(b) ? (a = RegExp(b.source)) : X(b) && (a = ba(b, {})));
		return a;
	}
	function Wb(b, a) {
		a = a || {};
	...
	function lc(b) {
		...
		"function" == typeof b
			? (a = b.$inject) ||
				((a = []),
				b.length &&
					((c = b.toString().replace(jd, "")),
					(c = c.match(kd)),
					r(c[1].split(ld), function(b) {
				...
				if (!k.get(a)) {
					...
					try {
						if (y(a))
							...
							O(a)
								? b.push(n.invoke(a))
								: I(a) ? b.push(n.invoke(a)) : Pa(a, "module");
					} catch (l) {
					...
					return (
						...
						d.history
							? c
								...
								: (l.pushState(null, "", a), J.attr("href", J.attr("href")))
		...
		g.cookies = function(a, b) {
			...
			if (a)
				b === s
					...
					: y(b) &&
						((d =
							(m.cookie = escape(a) + "=" + escape(b) + ";path=" + V).length +
							1),
						4096 < d &&
							c.warn(
								"Cookie '" +
					...
					for (
						...
						(e = d[f]),
							...
							0 < g &&
								...
								M[a] === s && (M[a] = unescape(e.substring(g + 1))));
				return M;
			}
		};
			...
			function b(b, d) {
				...
				return (a[b] = {
					put: function(a, b) {
						...
						if (!C(b))
							return a in m || h++, (m[a] = b), h > k && this.remove(q.key), b;
					},
					get: function(a) {
						if (k < Number.MAX_VALUE) {
							var b = l[a];
		...
		this.$get = [
			...
			function(a, b, n, q, p, A, E, B, u, H, J, w) {
				...
				function M(a, b, c, d, e, f) {
					...
					for (var h = [], k, l, n, p, q = 0; q < a.length; q++)
						(k = new Ib()),
							(l = V(a[q], [], k, 0 === q ? d : s, e)),
						...
						case 8:
							try {
								if ((k = e.exec(a.nodeValue)))
									(p = ka(k[1])), v(b, p, "M", d, g) && (c[p] = ca(k[2]));
							} catch (w) {}
					}
					b.sort(F);
					return b;
				...
				function Va(a, c, d, e, f, g, h, k, p) {
					...
					function B(a, e, f, g, p) {
						...
						if (M) {
							...
							aa && aa === M.$$originalDirective
								? g.data("$isolateScope", V)
								: g.data("$isolateScopeNoTemplate", V);
					...
					for (
						...
						if ((t = G.scope))
							(u = u || G),
								G.templateUrl ||
									(S("new/isolated scope", M, G, K), X(t) && (M = G));
						ga = G.name;
						!G.templateUrl &&
							G.controller &&
							((t = G.controller),
							(J = J || {}),
							S("'" + ga + "' controller", J[ga], G, K),
							(J[ga] = G));
						if ((t = G.transclude))
							(Va = !0),
								G.$$tlb || (S("transclusion", v, G, K), (v = G)),
								"element" == t
									? ((Ia = !0),
										(w = G.priority),
										(t = N(c, R, W)),
										(K = d.$$element = z(
											U.createComment(" " + ga + ": " + d[ga] + " ")
										)),
										(c = K[0]),
										nb(f, z(va.call(t, 0)), c),
										(F = Y(t, e, w, g && g.name, {
						...
						if (G.template)
							if (
								(S("template", aa, G, K),
								(aa = G),
								(t = O(G.template) ? G.template(K, d) : G.template),
								(t = oc(t)),
								G.replace)
							) {
								g = G;
						...
						if (G.templateUrl)
							S("template", aa, G, K),
								(aa = G),
								G.replace && (g = G),
								(B = P(a.splice(D, a.length - D), K, d, f, F, h, k, {
							...
							try {
								(pa = G.compile(K, d, F)),
									O(pa) ? q(null, pa, R, W) : pa && q(pa.pre, pa.post, R, W);
							} catch ($) {
								n($, fa(K));
							}
				...
				function P(a, b, c, d, e, f, g, h) {
					...
					b.empty();
					q
						.get(H.getTrustedResourceUrl(B), { cache: p })
						.success(function(p) {
							var q, H;
							p = oc(p);
							if (E.replace) {
								...
								return {
									pre: function(c, d, h) {
										...
										if ((f = b(h[e], !0, Ia(a, e))))
											(h[e] = f(c)),
												((d[e] || (d[e] = [])).$$inter = !0),
												((h.$$observers && h.$$observers[e].$$scope) ||
													c
				...
				var R = b.startSymbol(),
					...
					oc =
						"{{" == R || "}}" == W
							? Aa
							: function(a) {
									return a.replace(/\{\{/g, R).replace(/}}/g, W);
								},
					pa = /^ngAttr[A-Z]/;
				return Y;
			}
			...
			function(c, d) {
				return function(e, f) {
					...
					y(e) &&
						...
						(g = h[1]),
						(m = h[3]),
						(e = b.hasOwnProperty(g)
							? b[g]
							: dc(f.$scope, g, !0) || dc(d, g, !0)),
						Pa(e, g, !0));
					h = c.instantiate(e, f);
					if (m) {
						if (!f || "object" != typeof f.$scope)
							throw F("$controller")("noscp", g || e.name, m);
						f.$scope[m] = h;
					}
					return h;
				};
		...
		var b = /^\s*(\[|\{[^\{])/,
			...
			e = (this.defaults = {
				transformResponse: [
					function(d) {
						y(d) &&
							((d = d.replace(c, "")), b.test(d) && a.test(d) && (d = Yb(d)));
						return d;
					}
				],
				transformRequest: [
					function(a) {
						return X(a) && "[object File]" !== Ba.call(a) ? oa(a) : a;
					}
				],
				headers: {
			...
			function(a, b, c, d, n, q) {
				...
				function A(b, c, f) {
					...
					(b.cache || e.cache) &&
						...
						(u = X(b.cache) ? b.cache : X(e.cache) ? e.cache : B);
					if (u)
						if (((r = u.get(s)), v(r))) {
				...
				var B = c("$http"),
					u = [];
				r(f, function(a) {
					u.unshift(y(a) ? q.get(a) : q.invoke(a));
				});
				r(h, function(a, b) {
		...
		return function(e, m, k, l, n, q, p, A) {
			...
			if ("jsonp" == P(e)) {
				...
				var J = f(
					...
					function() {
						d[H].data ? B(l, 200, d[H].data) : B(l, u || -2);
						d[H] = Ca.noop;
					}
				);
			} else {
	...
	function Bd() {
		...
		this.$get = [
			...
			function(c, d, e) {
				function f(f, k, l) {
					for (var n, q, p = 0, A = [], E = f.length, B = !1, u = []; p < E; )
						-1 != (n = f.indexOf(b, p)) && -1 != (q = f.indexOf(a, n + h))
							? (p != n && A.push(f.substring(p, n)),
								A.push((p = c((B = f.substring(n + h, q))))),
								(p.exp = B),
								(p = q + g),
								(B = !0))
							: (p != E && A.push(f.substring(p)), (p = E));
							...
							(p = function(a) {
								try {
									for (var b = 0, c = E, g; b < c; b++)
										"function" == typeof (g = A[b]) &&
											((g = g(a)),
											(g = l ? e.getTrusted(l, g) : e.valueOf(g)),
											null === g || C(g)
												? (g = "")
												: "string" != typeof g && (g = oa(g))),
											(u[b] = g);
									return u.join("");
								} catch (h) {
			...
			function(c, d, e, f) {
				...
				f.on("click", function(a) {
					if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
						for (var b = z(a.target); "a" !== P(b[0].nodeName); )
						...
						var h = g.$$rewrite(e);
						e &&
							(!b.attr("target") && h && !a.isDefaultPrevented()) &&
							(a.preventDefault(),
							h != d.url() &&
								(g.$$parse(h),
								c.$apply(),
				...
				c.$watch(function() {
					...
					(l && a == g.absUrl()) ||
						(l++,
						c.$evalAsync(function() {
							c.$broadcast("$locationChangeStart", g.absUrl(), a)
								.defaultPrevented
								? g.$$parse(a)
								: (d.url(g.absUrl(), b), h(a));
						}));
					g.$$replace = !1;
					return l;
				});
	...
	function Sd() {
		this.$get = [
			...
			function(b, a) {
				var c = {},
					d = R(
						(/android (\d+)/.exec(P((b.navigator || {}).userAgent)) || [])[1]
					),
				...
				if (k) {
					...
					!d ||
						(l && n) ||
						((l = y(f.body.style.webkitTransition)),
					...
					"boolean" === d && c
						...
						: function(a, b) {
								if (a && b && "object" === typeof a && "object" === typeof b) {
									for (var d in a)
										if ("$" !== d.charAt(0) && $d.call(a, d) && c(a[d], b[d]))
											return !0;
									return !1;
								}
								b = ("" + b).toLowerCase();
	...
	function Kc(b, a, c, d, e) {
		...
		if (k) 0 < e && (-1 < b && 1 > b) && (g = b.toFixed(e));
			...
			var l = 0,
				...
				q = a.gSize;
			if (h.length >= n + q)
				for (l = h.length - n, k = 0; k < l; k++)
					0 === (l - k) % q && 0 !== k && (g += c), (g += h.charAt(k));
			for (k = l; k < h.length; k++)
				0 === (h.length - k) % n && 0 !== k && (g += c), (g += h.charAt(k));
			for (; b.length < e; ) b += "0";
	...
	function Hc(b) {
		...
		return function(c, e) {
			...
			for (; e; )
				(m = be.exec(e))
					? ((h = h.concat(va.call(m, 1))), (e = h.pop()))
					: (h.push(e), (e = null));
			r(h, function(a) {
				g = ce[a];
				f += g
					? g(c, b.DATETIME_FORMATS)
	...
	function Za(b, a, c, d, e, f) {
		...
		var m = function() {
			if (!g) {
				...
				if (d.$viewValue !== e || (h && "" === e && !h.valueMissing))
					b.$$phase
						? d.$setViewValue(e)
						: b.$apply(function() {
								d.$setViewValue(e);
	...
	isNaN(Q) &&
		(Q = R((/trident\/.*; rv:(\d+)/.exec(P(navigator.userAgent)) || [])[1]));
	x.$inject = [];
	Aa.$inject = [];
	var ca = (function() {
	...
	var dd = /[A-Z]/g,
		...
		Ra = (S.cache = {}),
		fb = (S.expando = "ng-" + new Date().getTime()),
		hd = 1,
		Pc = D.document.addEventListener
			? function(b, a, c) {
		...
		Gb = D.document.removeEventListener
			? function(b, a, c) {
		...
		Ga = (S.prototype = {
			ready: function(b) {
				...
				"complete" === U.readyState
					? setTimeout(a)
					: (this.on("DOMContentLoaded", a), S(D).on("load", a));
			},
			toString: function() {
				var b = [];
				r(this, function(a) {
	...
	r(
		...
		function(b, a) {
			S.prototype[a] = function(a, d) {
				var e, f;
				if (b !== ic && (2 == b.length && b !== Hb && b !== hc ? a : d) === s) {
					if (X(a)) {
	...
	Ob.prototype = {
			...
			for (a = []; this.index < this.text.length; ) {
				...
				if (this.is("\"'")) this.readString(this.ch);
					...
					var d = this.ch + this.peek(),
						...
						g = La[e];
					g
						? (this.tokens.push({ index: this.index, text: e, fn: g }),
							(this.index += 3))
						: h
							? (this.tokens.push({ index: this.index, text: d, fn: h }),
								(this.index += 2))
							: f
								? (this.tokens.push({
										index: this.index,
		...
		readIdent: function() {
			for (
				var a = this, c = "", d = this.index, e, f, h, g;
			...
			h &&
				...
				this.tokens.push({ index: e + 1, text: h, json: !1 }));
		},
		readString: function(a) {
			...
			for (var d = "", e = a, f = !1; this.index < this.text.length; ) {
				...
				if (f)
					"u" === h
						? ((h = this.text.substring(this.index + 1, this.index + 5)),
							h.match(/[\da-f]{4}/i) ||
								this.throwError("Invalid unicode escape [\\u" + h + "]"),
							(this.index += 4),
	...
	Ya.prototype = {
		...
		objectIndex: function(a) {
			...
			return t(
				function(e, f) {
					...
					if (!h) return s;
					(h = Xa(h[g], c.text)) &&
						(h.then && c.options.unwrapPromises) &&
						((m = h),
						"$$v" in h ||
							((m.$$v = s),
							m.then(function(a) {
		...
		functionCall: function(a, c) {
			...
			var e = this;
			return function(f, h) {
				for (var g = [], m = c ? c(f, h) : f, k = 0; k < d.length; k++)
					g.push(d[k](f, h));
				k = a(f, h, m) || x;
				Xa(m, e.text);
				Xa(k, e.text);
	...
	var Qc = function(a) {
		...
		Vc = {
			text: Za,
			date: $a("date", Rc, wb(Rc, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
			"datetime-local": $a(
				"datetimelocal",
				Sc,
				wb(Sc, ["yyyy", "MM", "dd", "HH", "mm"]),
				"yyyy-MM-ddTHH:mm"
			),
			...
			number: function(a, c, d, e, f, h) {
				...
				d.max &&
					...
					e.$formatters.push(a));
				e.$formatters.push(function(a) {
					return ma(e, "number", e.$isEmpty(a) || yb(a), a);
				});
			},
			...
			function(a, c, d, e, f, h) {
				...
				this.$setValidity = function(a, c) {
					q[a] !== !c &&
						(c
							? (q[a] && n--,
								n || (g(!0), (this.$valid = !0), (this.$invalid = !1)))
							: (g(!1), (this.$invalid = !0), (this.$valid = !1), n++),
						(q[a] = !c),
						g(c, a),
			...
			function(a, c) {
				...
				return {
					...
					link: function(e, f, h) {
						...
						r(h, function(a, c) {
							s.test(c) &&
								(l[P(c.replace("when", "").replace("Minus", "-"))] = f.attr(
									h.$attr[c]
								));
						});
						r(l, function(a, e) {
							...
							d.$render = function() {
								...
								e.hasOption(a)
									? (y.parent() && y.remove(),
										c.val(a),
										"" === a && x.prop("selected", !0))
									: C(a) && x ? c.val("") : e.renderUnknownOption(a);
							};
						...
						function n(e, f, g) {
							function h() {
								...
								for (D = 0; (C = A.length), D < C; D++) {
									...
									p
										? (d = v(s.remove(w ? w(e, B) : r(e, B))))
										: (w
												? ((d = {}), (d[m] = t), (d = w(e, d) === w(e, B)))
												: (d = t === r(e, B)),
											(s = s || d));
									L = l(e, B);
									L = v(L) ? L : "";
