four51.app.factory("XLATService", [
	"$interpolate",
	function($interpolate) {
		...
		var _getCurrentLanguage = function(userLanguage, userCulture) {
			...
			return [
				currentCulture,
				tables["Currency"][currentCulture],
				tables["Date"][currentCulture]
			];
		};
...
four51.app.filter("culturecurrency", [
	"XLATService",
	function(XLATService) {
