four51.app.factory("Variant", [
	"$rootScope",
	"$resource",
	"$451",
	"Security",
	"Error",
	function($rootScope, $resource, $451, Security, Error) {
		...
		var _save = function(variant, success) {
			...
			return $resource($451.api("variant"))
				.save(variant)
				.$promise.then(function(v) {
					var queryParams = {
						ProductInteropID: v.ProductInteropID,
