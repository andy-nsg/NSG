...
four51.app.directive("node", [
	...
	function($compile) {
		var obj = {
			...
			template:
				'<li class="451_cat_item" ng-class="{\'active\':  current.InteropID == node.InteropID}"><a ng-href="catalog/{{node.InteropID}}" ng-bind-html="node.Name"></a></li>',
